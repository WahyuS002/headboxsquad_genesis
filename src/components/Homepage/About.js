            ...
            <div className="grid md:grid-cols-7 gap-2 items-center">
                ...
                <div className="md:col-span-4 mt-8 md:mt-0 md:ml-5">
                    ...
                    <p className="text-neutral-700 mt-3 md:mt-6 leading-relaxed">
                        ...
                        consisting of 999 units and land for each owner. Each character of the Headbox Squad is rendered from a variety of skin, outfits, boxes, and facial expressions with over 500
